...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"İlk",sLast:"Son",sNext:"Sonraki",sPrevious:"Önceki"},sEmptyTable:"Herhangi bir kayıt bulunamadı.",sInfo:"_TOTAL_ kayıttan _START_ ile _END_ arası gösteriliyor.",sInfoEmpty:"Herhangi bir kayıt bulunamadı.",
sInfoFiltered:"(Toplam _MAX_ kayıttan filtrelendi.)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"_MENU_ adet kayıt göster",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Ara:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Kayıt bulunamadı."},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
