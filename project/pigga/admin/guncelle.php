...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="content my-5 p-lg-5">
            ...
            <form method="post" action="guncelleSecilen.php">
                    ...
                    if ($sorgu->rowCount()>0){
                        foreach ($Kayitlar as $item){ ?>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle"><button type="submit" class="btn btn-primary"><a href="guncelleSecilen.php?gelenId=<?php echo $item['id']; ?>" class="text-light">Güncelle</a></button></td>
                            </tr>
