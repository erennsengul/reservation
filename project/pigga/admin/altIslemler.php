        ...
        <div class="content my-5 p-lg-5">
            ...
            <form method="post">
                <table class="table table-striped w-100">
                    ...
                    <tbody>
                    <?php
                    $sorgu = $connect->prepare("SELECT * FROM alt_yemekler");
                    $sorgu->execute();
                        ...
                        foreach ($Kayitlar as $item){ ?>
                            <tr>
                                ...
                                <td style="vertical-align: middle">
                                    <button type="submit" class="btn btn-danger"><a href="altIslemler.php?id=<?php echo $item['id']; ?>" class="text-light">Sil</a></button>
                                    <button type="submit" class="btn btn-primary"><a href="altGuncelle.php?id=<?php echo $item['id']; ?>" class="text-light">Guncelle</a></button>
                                </td>
                            </tr>
            ...
            if (!empty($_GET["id"])){
                $getId = $_GET["id"];
                $sil = $connect->prepare("DELETE FROM alt_yemekler WHERE id=?");
                $sil->execute(array($getId));
                if ($sil){
                    header("location: altIslemler.php?silOk=tamam");
                    die();
                }else{
